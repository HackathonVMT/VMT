...
if(isset($_SESSION['uid']))
  ...
  $q = "select vehicle_name from  vehicle  where user_id = $uid";
    $r= $con->query($q);
    ...
    $user_id_query = "select user_id from vehicle where vehicle_type='car' and vehicle_name ='$vn'" ;
...
var layout1 = {
  title: 'Mileage with same car names',
  width:600,
  height:500,
  xaxis: {
    title: 'date',
